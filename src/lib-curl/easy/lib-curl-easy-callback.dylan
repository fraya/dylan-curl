...
// end
//
define thread variable *curl-write-callback*    :: false-or(<function>) = #f;
define thread variable *curl-header-callback*   :: false-or(<function>) = #f;
define thread variable *curl-debug-callback*    :: false-or(<function>) = #f;
define thread variable *curl-progress-callback* :: false-or(<function>) = #f;
...
define function curl-progress-callback
    (user-data       :: <C-void*>,    // pointer to xferinfodata
